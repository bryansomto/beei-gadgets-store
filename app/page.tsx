...
export default async function Home() {
  ...
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-16 xl:pt-24 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your one-stop{" "}
                <span className="bg-green-600 px-2 text-white">Gadget</span>{" "}
                shop for mobile and home devices.
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Make your space smart and fun with{" "}
                <span className="font-semibold">our excellent</span> device
                deals. BeeiGadgets provides you with the best deals on mobile or
                home gadgets.
              </p>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              />
              <Phone className="w-64" imgSrc="/beei-2.png" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
