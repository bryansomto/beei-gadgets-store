...
export default function Nav({ show }) {
  ...
  const inactiveIcon = "w-6 h-6 mr-1";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-600 p-4 mr-0 fixed w-full bg-bgGray h-full sm:static sm:w-auto transition-all"
      }
    >
      <nav className="flex flex-col gap-2 w-full">
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname.includes("/admin/products") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname.includes("/admin/orders") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        <Link
          href={"/admin/admins"}
          className={
            pathname.includes("/admin/admins") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes("/admin/admins") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname.includes("/admin/settings") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
